  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        variant === "line" && [
          "relative",
          "before:absolute before:-bottom-0.5 before:h-0.5 before:bg-foreground before:transition-all",
